...
Case cases[] = {
    ...
    Case("Analog Input on AIN_1", AnalogInput_Test<MBED_CONF_APP_AIN_1,MBED_CONF_APP_DIO_3,MBED_CONF_APP_DIO_4,MBED_CONF_APP_DIO_5,MBED_CONF_APP_DIO_6,MBED_CONF_APP_DIO_7>,greentea_failure_handler),
    // Case("Analog Input on AIN_2", AnalogInput_Test<MBED_CONF_APP_AIN_2,MBED_CONF_APP_DIO_3,MBED_CONF_APP_DIO_4,MBED_CONF_APP_DIO_5,MBED_CONF_APP_DIO_6,MBED_CONF_APP_DIO_7>,greentea_failure_handler),
